...
# Fixes: en la funcion save_crop_images, en la linea 43 "int(cat), i, entry["img_id"].rsplit(os.sep, 1)[1])" le cambie os.sep() por os.sep
# Fixes: Cambie el modelo de deteccion por el MegaDetectorV6
# Fixes: cambie el acelerador a cpu y le quite los devices.
